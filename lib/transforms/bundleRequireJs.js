...
if (!outgoingRelation.to.isAsset) {
console.warn("Skipping unpopulated", outgoingRelation.toString(), outgoingRelation.node);
...
return;
                        ...
                        if (/^JavaScriptAmd(?:Define|Require)$/.test(outgoingRelation.type)) {
                            if (outgoingRelation.to.type === 'JavaScript') {
                                ...
                                console.error("bundleRequireJs: Skipping unsupported outgoing relation: " + outgoingRelation.toString());
                            }
